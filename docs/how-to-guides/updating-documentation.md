...
The website is generated using [Material for MkDocs](https://squidfunk.github.io/mkdocs-material) and can be viewed at [homelab.ostreros.xyz](https://homelab.ostreros.xyz).
...
<!-- - Find the TXT record for `homelab.ostreros.xyz` and switch the `ownerID` between `homelab` and `horus` -->
